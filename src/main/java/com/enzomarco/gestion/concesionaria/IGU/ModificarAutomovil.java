...
public class ModificarAutomovil extends javax.swing.JFrame {
    ...
    ControladorLogica controlG;
    Automovil auto = new Automovil();
    
    
    public ModificarAutomovil(int idAuto) {
        controlG = new ControladorLogica();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        controlG.modificarAutomovil(
            auto, txtModelo.getText(), txtMarca.getText(), txtMotor.getText(), txtColor.getText(),
    ...
    private void cargarDatosAuto(int idAuto) {
        auto = controlG.traerAutomovil(idAuto);
        ...
        txtPuertas.setText(Integer.toString(auto.getCantPuertas()));
    }
